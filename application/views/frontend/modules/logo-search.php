    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> 0964.689.432
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> hungqb.1205@gmail.com
        </div>
      </div>
        ...
        <div class="input-search">
          ...
          <button>
             <!--  <ul class="search-quick">
                <li>
                  <a href="">
                    <img src="https://cdn.tgdd.vn/Products/Images/42/196963/16-200x200.jpg">
                    <h3>Ruốc tôm sinh thái Mùa 50g</h3>
